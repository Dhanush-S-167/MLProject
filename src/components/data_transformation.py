...
class DataTransformationConfig:
    preprocessor_obj_file_path = os.path.join('artifacts', "preprocessor.pkl")  # ✅ Fixed spelling
        ...
        try:
            ...
            cat_pipeline = Pipeline(
                steps=[
                    ...
                    ("one_hot_encoder", OneHotEncoder(handle_unknown='ignore', sparse_output=False)),  # 🔹 Convert to dense
                    ("scaler", StandardScaler(with_mean=False))  # ✅ Avoid centering issues
                ]
            )
